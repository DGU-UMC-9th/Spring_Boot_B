...
import com.example.umc9th.domain.mission.dto.MissionStatusDto;
...
public interface MemberMissionRepository extends JpaRepository<MemberMission, Long> {
    ...
    @Query("select new com.example.umc9th.domain.mission.dto.MissionStatusDto(s.name, m.reward, m.missionSpec, mm.status) " +
    ...
    //내가 수행했고, 수행 중인 미션의 이름, 보상, 내용, 상태를 가져온다.
